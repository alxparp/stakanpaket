...
<div class="content">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>Производитель:</td>
                <td><input class="head-text" type="text" name="manufacturer" value="<?=htmlspecialchars($get_specifications['manufacturer'])?>" /></td>
            </tr>
            <tr>
                <td>Модель:</td>
                <td><input class="head-text" type="text" name="model" value="<?=htmlspecialchars($get_specifications['model'])?>" /></td>
            </tr>
            <tr>
                <td>Тип авто:</td>
                <td><input class="head-text" type="text" name="type_auto" value="<?=htmlspecialchars($get_specifications['type_auto'])?>" /></td>
            </tr>
            <tr>
                <td>Ширина:</td>
                <td><input class="head-text" type="text" name="width" value="<?=htmlspecialchars($get_specifications['width'])?>" /></td>
            </tr>
            <tr>
                <td>Профиль:</td>
                <td><input class="head-text" type="text" name="profile_auto" value="<?=htmlspecialchars($get_specifications['profile_auto'])?>" /></td>
            </tr>
            <tr>
                <td>Диаметр:</td>
                <td><input class="head-text" type="text" name="diameter" value="<?=htmlspecialchars($get_specifications['diameter'])?>" /></td>
            </tr>
            <tr>
                <td>Сезонность:</td>
                <td><input class="head-text" type="text" name="seasonality" value="<?=htmlspecialchars($get_specifications['seasonality'])?>" /></td>
            </tr>
            <tr>
                <td>Индекс:</td>
                <td><input class="head-text" type="text" name="index_auto" value="<?=htmlspecialchars($get_specifications['index_auto'])?>" /></td>
            </tr>
            <tr>
                <td>Страна:</td>
                <td><input class="head-text" type="text" name="country" value="<?=htmlspecialchars($get_specifications['country'])?>" /></td>
            </tr>
<!--            <tr>-->
<!--                <td colspan="2">-->
...
<!--            </tr>-->
            ...
            <tr>
                <td>Отметить как:</td>
                <td><input type="checkbox" name="new" value="1" <?php if($get_product['new']) echo 'checked=""'; ?> /> Рекомендуемые <br />
